...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/lihongliangAndliyan/MeTest"
  ...
  s.source       = { :git => "https://github.com/lihongliangAndliyan/MeTest.git", :tag => "0.0.2" }


  s.source_files  = "Classes", "MeTest/Classes/**/*.{h,m}"
